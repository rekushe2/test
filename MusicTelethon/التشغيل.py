...
async def ytdl(link):
    ...
    if stdout:
        ...
        return 0, stderr.decode()
@Client.on_message(    filters.user(SUDO_USERS) & filters.command([""], prefixes=f"{HNDLR}"))
...
@Client.on_message(    filters.user(SUDO_USERS) & filters.command(["_"], prefixes=f"{HNDLR}"))
@authorized_users_only
...
@Client.on_message(    filters.user(SUDO_USERS) & filters.command([" ", "queue"], prefixes=f"{HNDLR}"))
@authorized_users_only
